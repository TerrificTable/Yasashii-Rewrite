package com.terrifictable55.yasashii.clickgui.component;
...
public class Frame {
	...
	public Frame(Category cat) {
		...
		for(Module mod : Yasashii.moduleManager.getModulesByCategory(category)) {
	...
	public void renderFrame(FontRenderer fontRenderer) {
		...
		fontRenderer.drawStringWithShadow(this.category.name(), (this.x + 2) * 2 + 5, (this.y + 2.5f) * 2 + 5, 0x4F4E4E);
