...
import static com.terrifictable55.yasashii.utils.Utils.isMoving;

public class AntiCheat extends Module {
    Setting Experimental = rSetting(new Setting("Experimental", this, true));

    public AntiCheat() {
        super("CheatDetect", Category.MISC);
    }
    ...
    public void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        for (Entity entityplayer : mc.world.loadedEntityList) {
            if (entityplayer instanceof EntityPlayer && !(entityplayer.getName().equalsIgnoreCase(mc.player.getName()))) {
