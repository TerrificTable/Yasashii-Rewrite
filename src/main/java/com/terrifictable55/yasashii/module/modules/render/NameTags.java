...
import com.terrifictable55.yasashii.module.modules.combat.TotemPop;
...
public class NameTags extends Module {
    ...
    public Setting Scale = rSetting( new Setting("Scale", this, 2, 0, 4, false));
    public Setting armor = rSetting( new Setting("armor", this, true));
    public Setting Background = rSetting( new Setting("Background", this, 0, 1, .01, .22));
    public  Setting TextColor = rSetting( new Setting("Name", this, 0, 1, 1, 1));
    public Setting ScaleMode = rSetting( new Setting("Armor Mode", this, "H", "H", "V"));
    public Setting Gamemode = rSetting( new Setting("Gamemode", this, true));
    public Setting Player = rSetting( new Setting("Player", this, true));
    public Setting Ping = rSetting( new Setting("Ping", this, true));
    public Setting Mob = rSetting( new Setting("Mob", this, false));
    public Setting Hostile = rSetting( new Setting("Hostile", this, false));
    public Setting Totem = rSetting( new Setting("Totem Pops", this, false));
    public Setting Healthmode = rSetting( new Setting("Health Mode", this, "Number", "Number", "Bar"));
    ...
    public static void drawItem(double x, double y, double z, double offX, double offY, double scale, ItemStack item) {
        ...
        mc.getItemRenderer().renderItemSide(mc.player, item, ItemCameraTransforms.TransformType.NONE, false);
        GlStateManager.enableTexture2D();
