...
public class HackTessellator extends Tessellator {
    public static HackTessellator INSTANCE = new HackTessellator(GL_MAP1_COLOR_4);

    public HackTessellator(int p_i1250_1_) {
        super(0x200000);
    }
