...
import com.terrifictable55.yasashii.module.modules.misc.ModSettings;
...
import static com.terrifictable55.yasashii.utils.ColourUtils.colorcalc;
import static com.terrifictable55.yasashii.utils.ColourUtils.glColor;
...
public class RenderUtil {
    ...
    public static void RenderLine(List<Vec3d> List, int Color, double width, boolean valBoolean) {
        ...
        for (Vec3d blockPos : List) {
            if (valBoolean) {
                ...
                GL11.glVertex3d(snap.getX() - renderManager.viewerPosX, snap.getY() - renderManager.viewerPosY, snap.getZ() - renderManager.viewerPosZ);
            } else
    ...
    public static Vec3d getInterpolatedRenderPos(Vec3d pos) {
        return new Vec3d(pos.x, pos.y, pos.z).subtract(mc.getRenderManager().renderViewEntity.posX, mc.getRenderManager().renderViewEntity.posY, mc.getRenderManager().renderViewEntity.posZ);
    }
